\section{Teoremi della divergenza, del gradiente e del rotore}
...
\subfloat[][\emph Dominio semplice $R$. \'E possibile rappresentare il contorno di $R$ come unione delle due curve $\ell_1$, $\ell_2$ i cui punti possono essere identificati in maniera univoca dalla coordinata loro $x$: $Y_1(x)$ e $Y_2(x)$ sono funzioni.]
